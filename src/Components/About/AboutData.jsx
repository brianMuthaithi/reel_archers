import image1 from "../../Assets/Us/attention.svg";
import image2 from "../../Assets/Us/communication.jpg";
import image3 from "../../Assets/Us/design.jpg";
import image4 from "../../Assets/Us/experience.png";
import image5 from "../../Assets/Us/flexibility.jpeg";
import image6 from "../../Assets/Us/portfolio.jpeg";

//projects
import img1 from "../../Assets/Projects/swimming/swim1.jpg";
import img2 from "../../Assets/Projects/commercial/com11.webp";
...
export const data = [
  {
    ...
    text: "We have a proven track record of successfully completing projects similar to yours, and our team of experienced architects and designers are dedicated to creating innovative and sustainable designs.",
  },
  {
    image: image3,
    title: "Design philosophy",
    text: "Our design philosophy is centered on creating functional, beautiful and sustainable structures that meet the specific needs of our clients. We work closely with you throughout the entire design process to ensure that your vision is translated into reality.",
  },
  {
    image: image6,
    title: "Portfolio",
    text: "Our portfolio includes a diverse range of projects, from different clients that we have worked for, demonstrating our versatility and ability to adapt to different styles and designs.",
  },
  {
    image: image5,
    title: "Flexibility",
    text: "We are open to new ideas and are flexible to work with, ensuring that your project meets your specific needs and requirements.",
  },
  {
    image: image2,
    title: "Communication and responsiveness",
    text: "We believe that clear and open communication is key to the success of any project, and we are always available to answer any questions you may have.",
  },
  {
    image: image1,
    title: "Sustainable approach",
    text: "We have a sustainable approach to architecture and incorporate green building practices in all of our projects, ensuring that your building is energy-efficient and environmentally friendly.",
  },
];
